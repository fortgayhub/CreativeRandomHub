...
if Bypass == "death" then
	bullet = game.Players.LocalPlayer.KomReanimation["HumanoidRootPart"]
...
if game.Players.LocalPlayer.KomReanimation[ToolName].Handle:FindFirstChild("AccessoryWeld") then game.Players.LocalPlayer.KomReanimation[ToolName].Handle:FindFirstChild("AccessoryWeld"):Destroy() end
...
Character=game.Players.LocalPlayer.KomReanimation
